...
public class Gezegenler : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        for (int i = 1; i < sprites.Length; i++)
        {
            ...
            gezegen.transform.parent = gameObject.transform;
    ...
    public void GezegenYerlestir(float refY)
    {
        ...
        //2. bölge
        float xDeger2 = Random.Range(0.0f, genislik);
        ...
        //3. bölge
        float xDeger3 = Random.Range(0.0f, -genislik);
        float yDeger3 = Random.Range(refY, refY - yukseklik);
        ...
        float yDeger4 = Random.Range(refY, refY + yukseklik);
